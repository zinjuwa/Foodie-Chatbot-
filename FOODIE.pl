/* FINAL PROJECT (COMP 4400)
  *Name – Prashil Zinjuwadia
   *ID – 104940570
   *Project title – FOODIE (the chatbot) */
...
/* ask - Since C is a list of relations on individuals, 
...
/* prove_all - iterates through the list of queries and variables
